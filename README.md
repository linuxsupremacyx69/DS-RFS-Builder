...
- **Native English localization**: Enable English language support with one click and automatically configure the timezone, removing the hassle of manual localization inside the container.
