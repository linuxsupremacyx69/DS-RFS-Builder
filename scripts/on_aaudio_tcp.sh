...
CONTAINER_NAME="ArchLinux"  # Container name
USERNAME="notshroud"   # rootfs username
DISPLAY_NUMBER=":0"    # Display number to start :0 :1 :2
DPI=350                # termux-x11 DPI
...
# The above is an installation example
...
if [ -n "$AAUDIO_SINK" ]; then
    ...
    echo "Audio device not found, please check if the module loaded successfully."
fi
